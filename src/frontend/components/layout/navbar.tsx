...
const sponsorNavItems: NavItem[] = [
  { label: 'Dashboard', href: '/sponsor/dashboard', authRequired: true, roles: ['sponsor'] },
  { label: 'Sponsorships', href: '/sponsor/sponsorships', authRequired: true, roles: ['sponsor'] },
  { label: 'Beneficiaries', href: '/sponsor/beneficiaries', authRequired: true, roles: ['sponsor'] },
  { label: 'Transactions', href: '/sponsor/transactions', authRequired: true, roles: ['sponsor'] },
];

const vendorNavItems: NavItem[] = [
  { label: 'Dashboard', href: '/vendor/dashboard', authRequired: true, roles: ['vendor'] },
  { label: 'My Transactions', href: '/vendor/transactions', authRequired: true, roles: ['vendor'] },
  { label: 'Profile/Categories', href: '/vendor/profile', authRequired: true, roles: ['vendor'] },
];
...
export const Navbar = () => {
  ...
  const { isOpen: mobileNavOpen, onOpen: openMobileNav, onClose: closeMobileNav } = useDisclosure();
            ...
            <Menu>
              ...
              >
                <HStack spacing={1}>
                  ...
                  <Text display={{base: 'none', md: 'inline-flex'}} fontWeight="normal">{user?.display_name || user?.email}</Text>
                </HStack>
              </MenuButton>
              <MenuList>
