...
const VendorDashboardPage: NextPage = () => {
  ...
  const pageError: unknown = errorVendorOwnCategories || errorEligibleSponsorships;
        ...
        <VStack spacing={6} align="stretch">
          ...
          {isPaymentModalOpen && (
            <AcceptPaymentModal
              ...
              errorEligibleSponsorships={errorEligibleSponsorships as QueryErrorWithValue | null}
            />
          )}
